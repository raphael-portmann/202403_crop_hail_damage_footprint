...
#data directory
data_dir='/home/raphael/scClim/climada/scClim/subproj_D/papers/NHESS/code_and_data/data/'
...
def plot_skill_haz_threshold(at_centroid_data_wheat,at_centroid_data_grapevine,variable,unit, figdir, thresh=0,resolution='1km'):
    ...
    ax2.set_yticks(np.arange(0,16001,4000),['','','','',''],color='grey')
    ...
    ax2=ax.twinx()
    ax2.bar(x,df['PRED'][x],width=1,color='lightgrey',zorder=0)
    ax2.set_yticks(np.arange(0,16001,4000),np.arange(0,16001,4000),color='lightgrey')
    ax2.set_ylim(0,16000)
    ax2.yaxis.label.set_color('lightgrey')
    ax.spines['right'].set_color('grey')
    ax2.spines['right'].set_color('grey')
...
def plot_CH_map(ncols=2,nrows=2, proj=ccrs.epsg(2056),stamen_map=True, 
    ...
    ch_shp_path = '/home/raphael/scClim/climada/data/TLM/'
